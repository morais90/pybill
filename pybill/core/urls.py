...
API_TITLE = 'pybill Calls Documentation'
API_DESCRIPTION = """
    pybill Calls is an application that helps in tracking the calls that your company makes.
...
urlpatterns = [
    path(r'', include('pybill.calls.urls')),
